...
public class MovieService
{
    ...
    public async Task<List<MovieDto>> GetPopularMoviesAsync()
    {
        ...
        // TMDB'den gelen karmaşık JSON verisini, kendi temiz DTO'muza çeviriyoruz (LINQ - Select)
        return response.Results.Select(t => new MovieDto
        {
            Id = t.Id,
            Title = t.Title,
            ReleaseYear = !string.IsNullOrEmpty(t.ReleaseDate) ? int.Parse(t.ReleaseDate.Substring(0, 4)) : 0,
